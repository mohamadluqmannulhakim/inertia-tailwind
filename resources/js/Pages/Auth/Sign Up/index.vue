<template>
  <div>
    <div
      class="min-h-screen flex items-center justify-center bg-purple-100 py-12 px-4 sm:px-6 lg:px-8"
    >
      <div class="max-w-md w-full border-4 shadow py-16 px-6 bg-gray-100">
        <div>
          <div>
            <svg
              class="block fill-current text-purple-500 css-1magkk1 mx-auto h-12 w-auto"
